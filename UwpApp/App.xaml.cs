...
namespace UwpApp
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            var dbOptions = new DbContextOptionsBuilder<ApplicationContext>().UseSqlServer("Data Source=reception\\SQLEXPRESS;Initial Catalog=Billing4;User Id=sa;Password=sa@12345;");
